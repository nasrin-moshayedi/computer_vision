...
def annotate_image_array(image_in):
	...
	vertices = np.array([[\
		((imshape[1] * (1 - trap_bottom_width)) // 4, imshape[0]),\
		((imshape[1] * (1 - trap_top_width)) // 4, imshape[0] - imshape[0] * trap_height),\
		(imshape[1] - (imshape[1] * (1 - trap_top_width)) // 4, imshape[0] - imshape[0] * trap_height),\
...
if __name__ == '__main__':
	...
	output_file = 'download1.jpg'
	image_only = 'download.jpg'
